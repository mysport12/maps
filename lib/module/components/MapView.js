...
class MapView extends NativeBridgeComponent(React.PureComponent, NativeMapViewModule) {
  ...
  _onCameraChanged(e) {
    ...
    (_this$props$onCameraC = (_this$props = this.props).onCameraChanged) === null || _this$props$onCameraC === void 0 ? void 0 : _this$props$onCameraC.call(_this$props, this._decodePayload(e.nativeEvent.payload));
  }
  _onChange(e) {
    const {
