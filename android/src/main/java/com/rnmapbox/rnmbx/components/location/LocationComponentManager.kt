...
class LocationComponentManager(mapView: RNMBXMapView, context: Context) {
    ...
    data class State(
        ...
        var shadowImage: ImageHolder?, // shadow image (shadow)
        var topImage: ImageHolder?, // top image (foreground)
        ...
        mapView.location.updateSettings {
            ...
            if (fullUpdate || (newState.hidden != oldState.hidden) || (newState.tintColor != oldState.tintColor) || (newState.bearingImage != oldState.bearingImage) || (newState.shadowImage != oldState.shadowImage) || (newState.topImage != oldState.topImage)) {
                if (newState.hidden) {
                    ...
                    defaultLocationPuck.shadowImage = newState.shadowImage ?: shadowImage
