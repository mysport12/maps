        ...
        mMapView?.locationComponentManager?.let {
            ...
            when (mRenderMode) {
                ...
                RenderMode.GPS -> it.update {
                    it.copy(
                        bearingImage = if (mNativeBearingImage != null) ResourceUtils.getDrawableByName(mContext, mNativeBearingImage) else AppCompatResourcesV11.getDrawableImageHolder(mContext, R.drawable.mapbox_user_bearing_icon),
                        shadowImage = if (mNativeShadowImage != null) ResourceUtils.getDrawableByName(mContext, mNativeShadowImage) else AppCompatResourcesV11.getDrawableImageHolder(mContext, R.drawable.mapbox_user_icon_shadow),
                        topImage = if (mNativeTopImage != null) ResourceUtils.getDrawableByName(mContext, mNativeTopImage) else AppCompatResourcesV11.getDrawableImageHolder(mContext, R.drawable.mapbox_user_icon),
